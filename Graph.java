...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			  g.addVertex("Delhi");
        g.addVertex("Modinagar");
        g.addVertex("Ghaziabad");
        g.addVertex("Meerut");
        g.addVertex("Muzaffarnagar");
        g.addVertex("Saharanpur");

        // Add connections (edges) between stations
        g.addEdge("Delhi", "Modinagar", 60);
        g.addEdge("Delhi", "Ghaziabad", 50);
        g.addEdge("Ghaziabad", "Modinagar", 40);
        g.addEdge("Ghaziabad", "Meerut", 70);
        g.addEdge("Meerut", "Muzaffarnagar", 80);
        g.addEdge("Meerut", "Saharanpur", 100);
